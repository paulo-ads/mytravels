...
@Component({
  ...
  template: `
    <div
      class="flex min-h-screen items-center justify-center bg-app-bg relative p-4 overflow-hidden"
    >
      ...
      >
        ...
        <h2 class="text-4xl font-serif font-bold mb-2 text-txt-main">Welcome back</h2>
        <p class="text-txt-muted text-sm mb-8">Sign in to continue your journey.</p>

        <div class="flex bg-surface-hover p-1 rounded-full mb-8">
          <button
            class="flex-1 py-2 rounded-full bg-brand text-txt-inv font-semibold text-sm shadow-sm transition-all"
          >
            Sign In
          </button>
          <a
        ...
        >
          ...
          <button
            ...
            class="w-full bg-brand text-btn-text font-bold py-3.5 px-4 rounded-full hover:bg-brand-hover transition-colors shadow-md disabled:opacity-50 mt-4 flex justify-center items-center gap-2 enabled:cursor-pointer disabled:cursor-not-allowed"
          >
          ...
          <div class="text-center mt-6 text-sm">
            <span class="text-txt-muted">New here? </span>
            <a
              routerLink="/signup"
              class="text-txt-main hover:text-brand transition-colors font-bold cursor-pointer"
              >Create account</a
            >
          </div>
        </form>
